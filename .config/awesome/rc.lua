...
beautiful.init(string.format("%s/.config/awesome/my_theme/theme.lua", os.getenv("HOME")))
-- }}}
...
globalkeys = my_table.join(
    ...
    --               if c thenawful.key({ modkey, "Control" }, "n",
    --           function ()
    --               local c = awful.client.restore()
    --               -- Focus restored client
    --               if c then
    ...
    -- awful.key({ modkey }, "v", function () awful.spawn.with_shell("xsel | xsel -o -b") end,
    ...
    awful.key({ modkey }, "d", function ()
            os.execute(string.format("dmenu_run -i -fn 'Monospace 12' -nb '%s' -nf '%s' -sb '%s' -sf '%s'",
