...
utils.map("n", "<leader><Tab>", "<cmd>e#<CR>", opts, "Movement", "cycle_last_buffer", "Goto last buffer")
-- utils.map("n", "<leader><Tab>", "<cmd>bnext<CR>", opts, "Movement", "cycle_next_buffer", "Goto next buffer")
-- utils.map(
--   "n",
--   "<leader><Tab>",
--   "<cmd>bprevious<CR>",
...
utils.map("n", "<esc>", "<cmd>noh<CR>", opts, "Editor", "no_highlight", "Turn off search highlighting")
...
if not functions.is_plugin_disabled("zen") then
  utils.map("n", "<F6>", "<cmd>TZAtaraxis<CR>", opts, "Editor", "open_zen", "Toggle Zen mode")
end
if not functions.is_plugin_disabled("restclient") then
  utils.map(
    "n",
    "<F7>",
    "<cmd><Plug>RestNvim<CR>",
    opts,
    "Editor",
    "exec_http",
...
utils.map("n", "<leader>wD", "<cmd>only<cr>", opts, "Window", "close_all_other_windows", "Close all other windows")
...
utils.map("n", "<leader>wH", "<C-W>h<cmd>MaximizerToggle<cr>", opts, "Window", "window_left_and_max", "Window left and maximize")
utils.map("n", "<leader>wJ", "<C-W>j<cmd>MaximizerToggle<cr>", opts, "Window", "window_below_and_max", "Window below and maximize")
utils.map("n", "<leader>wK", "<C-W>k<cmd>MaximizerToggle<cr>", opts, "Window", "window_up_and_max", "Window up and maximize")
utils.map("n", "<leader>wL", "<C-W>l<cmd>MaximizerToggle<cr>", opts, "Window", "window_right_and_max", "Window right and maximize")

utils.map("n", "<leader>wm", "<cmd>MaximizerToggle<cr>", opts, "Window", "window_max", "Window maximize toggle")
...
utils.map("n", "<leader>jp", "<cmd>pop<CR>", opts, "Jumps", "jump_pop_tag", "Pop from tag stack")

utils.map("n", "<leader>jC", "[czz", opts, "Jumps", "jump_previous_change", "Jump to previous change")
utils.map("n", "<leader>jc", "]czz", opts, "Jumps", "jump_next_change", "Jump to next change")
utils.map(
  "n",
  "<leader>jt",
  "<cmd>tag<CR>",
...
-- custom control motions
utils.map("n", "<C-j>", "Lzz", opts, "Motions", "jump_j_half_window", "Jump down")
utils.map("n", "<C-k>", "Hzz", opts, "Motions", "jump_k_half_window", "Jump up")
utils.map("n", "<C-l>", "$", opts, "Motions", "jump_line_end", "Jump right")
utils.map("n", "<C-h>", "^", opts, "Motions", "jump_line_start", "Jump left")

utils.map('n', '<leader>jw', "<cmd>HopWord<cr>", opts, "Motions", "jump_word", "Jump to word")
utils.map('n', '<leader>jl', "<cmd>HopLineStart<cr>", opts, "Motions", "jump_line_first_char", "Jump to first char of line")

-- comments
utils.map("n", "<leader>;", "<cmd>Commentary<cr>", opts, "Comment", "comment_line", "Comment line")
utils.map("v", "<leader>;", ":'<,'>Commentary<cr>", opts, "Comment", "comment_selection", "Comment selection")
