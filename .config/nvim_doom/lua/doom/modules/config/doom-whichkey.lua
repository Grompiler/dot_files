return function()
  ...
  local mappings = {
    ...
    ["p"] = {
      ...
      ["t"] = { "Browse project files and folders" },
      ["T"] = { "Open project tree" },
    },
    ["q"] = {
      name = "+quit/sessions",
    ...
    ["w"] = {
      ...
      ["l"] = { "Window right" },
      ["k"] = { "Window up" },
      ["H"] = { "Window left and maximize" },
      ["J"] = { "Window below and maximize" },
      ["K"] = { "Window up and maximize" },
      ["L"] = { "Window right and maximize" },
      ["="] = { "Balance window" },
